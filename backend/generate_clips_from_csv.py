...
def main():
    print("🎬 Generating Clips from CSV Data")
    print("=" * 50)
    
    # Parse CSV data
    csv_path = "media/engagement/proper_format_engagement.csv"
    ...
    clips_to_create = [
        {"name": "short_clip", "duration": 30},
        {"name": "medium_clip", "duration": 60},
        {"name": "long_clip", "duration": 90}
    ]
    ...
    for clip in clips_to_create:
        ...
        output_path = output_dir / f"kaicenat_peak_{clip['name']}_{start_time}_{clip['duration']}.mp4"
